			...
			//I know if they used something else
				...
				{	
					...
					{   
						...
						case 'c':flag = 'c'; counter =2; break;
						
								  
						default:  System.out.println("Please try again. (e) or (c)");
								  System.out.println("Tries: "+ (counter +1) );
								  flag = num.next().charAt(0);
						}
					}
				}
